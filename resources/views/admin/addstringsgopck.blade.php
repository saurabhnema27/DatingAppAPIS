...
<form action="/addstringgopck" style="margin-top: 7em;" method="POST">
    @if (session('success'))
    ...
    @csrf
        <div class="form-row">
          ...
          <div class="col-sm-6">
            ...
            <input type="text" name="superlike_count" class="form-control">
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            ...
            <input type="text" name="boosts_count" class="form-control">
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            ...
            <input type="text" name="change_location_count" class="form-control">
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            ...
            <input type="text" name="rewind_count" class="form-control">
          </div>
          <div class="col-sm-6">
