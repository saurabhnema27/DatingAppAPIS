                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                        <div class="card-body text-center">
                            ...
                            <p class="text-primary text-24 line-height-1 mb-2">{{count($data['users'])}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                        <div class="card-body text-center">
                            ...
                            <div class="content">
                                <p class="text-muted mt-2 mb-0">packages Sold</p>
                            <p class="text-primary text-24 line-height-1 mb-2">{{count($data['superlike']) + count($data['boosts']) + count($data['hiddenprofile']) + count($data['stringsgo'])}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                        <div class="card-body text-center">
                            ...
                            <div class="content">
                                <p class="text-muted mt-2 mb-0">Total StringGo</p>
                            <p class="text-primary text-24 line-height-1 mb-2">{{count($data['stringsgo'])}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                        <div class="card-body text-center">
                            <i class="i-Money-2"></i>
                            <div class="content">
                                <p class="text-muted mt-2 mb-0">Total swipe Done</p>
                            <p class="text-primary text-24 line-height-1 mb-2">{{count($data['totalswipe'])}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column flex-sm-row align-items-center mb-3">
                                <img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="#" alt="">
                                <div class="flex-grow-1">
                                    <h5 class=""><a href="">Car Insurance</a></h5>
                            ...
                            <div class="d-flex flex-column flex-sm-row align-items-center mb-3">
                                <img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="#" alt="">
                                <div class="flex-grow-1">
                                    <h5 class=""><a href="">Bike Insurance</a></h5>
                                    <p class="m-0 text-small text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            ...
                            <div class="d-flex flex-column flex-sm-row align-items-center mb-3">
                                <img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="#" alt="">
                                <div class="flex-grow-1">
                                    <h5 class=""><a href="">Member Policy</a></h5>
                                    <p class="m-0 text-small text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                    <p class="text-small text-danger m-0">$450 <del class="text-muted">$500</del></p>
                                </div>
                                <div>
